package com.elionlimanaj.csit551_w2_demo1;
...
import static com.elionlimanaj.csit551_w2_demo1.utils.Utils.APP_TAG;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_1_act1).setOnClickListener(new MyLsnr());
        findViewById(R.id.btn_2_act1).setOnClickListener(new MyLsnr());
    ...
    class MyLsnr implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.btn_1_act1) {
                textView1.setText(getString(R.string.label1));
                Intent intent = new Intent(MainActivity.this, Main2Activity.class);
                startActivity(intent);
            } else if (view.getId() == R.id.btn_2_act1)
